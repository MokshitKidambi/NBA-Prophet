...
class PredictorV1:
    def __init__(self):
        ...
        self.team_training_ground_path = Path("C:\\Users\\kidam\\OneDrive\\Documents\\pythonstuff\\NBA-Prophet\\gear3\\data\\features\\team_training_ground.csv")
    ...
    def experiment_predictor(self):
        ...
        player_training_ground = pandas.read_csv(self.player_feature_history)

        X_data = pandas.concat([team_training_ground[self.X], player_training_ground[self.player_experiment_features]], axis = 1)
    ...
    def test(self):
         ...
         print(player_feature_history.shape)
         print(player_feature_history.columns.tolist())
         print(player_feature_history.isna().sum())
         print(player_feature_history.duplicated(
            subset=["PLAYER_ID", "TEAM_ID", "SEASON"]).sum())
